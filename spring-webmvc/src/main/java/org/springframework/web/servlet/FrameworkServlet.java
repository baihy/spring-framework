...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
    ...
    protected WebApplicationContext initWebApplicationContext() {
        ...
        // 通过 ServletContext初始化ApplicationContext对象
        ...
        if (wac == null) {
            ...
            // 如果WebApplicationContext对象为null，就需要通过root对象，创建一个对象
    ...
    protected WebApplicationContext createWebApplicationContext(@Nullable ApplicationContext parent) {
        ...
        // 通过反射实例化ApplicationContext对象.
        ConfigurableWebApplicationContext wac = (ConfigurableWebApplicationContext) BeanUtils.instantiateClass(contextClass);
        wac.setEnvironment(getEnvironment());
        wac.setParent(parent);// 设置监听器创建的ApplicationContext和DispatcherServlet对象创建的ApplicationContext设置父子关系
    ...
    protected WebApplicationContext createWebApplicationContext(@Nullable WebApplicationContext parent) {
        // 获取出ContextLoaderListener监听器中通过配置文件创建的ApplicationContext对象。
